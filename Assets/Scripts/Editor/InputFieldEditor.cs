...
namespace Cuboid
{
    ...
    [CustomEditor(typeof(Cuboid.UI.InputField), true)]
    public class InputFieldEditor : SelectableEditor
    {
        ...
        SerializedProperty m_CantLoseFocus;
        ...
        protected override void OnEnable()
        {
            ...
            m_CantLoseFocus = serializedObject.FindProperty("m_CantLoseFocus");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    Cuboid.UI.InputField inputField = target as Cuboid.UI.InputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)Cuboid.UI.InputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)Cuboid.UI.InputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)Cuboid.UI.InputField.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)Cuboid.UI.InputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)Cuboid.UI.InputField.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)Cuboid.UI.InputField.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)Cuboid.UI.InputField.CharacterValidation.CustomValidator)
                        {
            ...
            if (m_foldout.extraSettings)
            {
                ...
                EditorGUILayout.PropertyField(m_CantLoseFocus, new GUIContent("Can't Lose Focus", "This means that when clicking outside the input field, it won't lose focus and still receive input events"));
